					...
					<div class="portfolio-holder row">
	    			    ...
	    			    <?php
	    			    	...
	    			    	while ( $portfolio_query->have_posts() ) {
	    			    		...
	    			    		// Add span to post class
	    			    		$span = ( get_post_meta( $parent_id, '_layout', true ) != 'full-width' ) ? 'span8' : 'span12';
					    		...
					    		<div data-id="id-<?php echo $counter; ?>" data-type="<?php echo $term_slugs; ?>" <?php post_class( $span . ' clear' ); ?>>
